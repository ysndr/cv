...
\PolyglossiaSetup{$polyglossia-lang$}{indentfirst=false}
$endif$
...
\IfFontExistsTF{$mainfont$}
  {
  \setmainfont[Ligatures={Common, Historic}, Numbers={OldStyle}, RawFeature={+ss04,+ss05}]{$mainfont$}
...
% % {
%   % \setmainfont[Ligatures={Common, Historic, Rare}, Numbers={OldStyle}, RawFeature={+ss04,+ss05}]{$mainfont$}
% % }
% {
%   \usepackage{$mainfont$}
%   % \usepackage[T1]{fontenc}
